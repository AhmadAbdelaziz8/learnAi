...
const progress = computed(() => {
  ...
  return Math.round(
    ((currentCardIndex.value + 1) / deck.value.flashcards.length) * 100
  );
});
...
<template>
  <div
    class="min-h-screen bg-gradient-to-br from-green-50 via-green-100 to-green-200"
  >
    <!-- Header -->
    ...
    <!-- Loading State -->
    <div
      v-if="deckStore.loading"
      class="flex items-center justify-center min-h-96"
    >
      <div class="text-center">
        <div
          class="w-12 h-12 border-4 border-green-200 border-t-green-500 rounded-full animate-spin mx-auto mb-4"
        ></div>
    ...
    >
      <div class="text-center">
        ...
        <p class="text-gray-600 mb-4">
          {{ deckStore.error.message || "Something went wrong" }}
        </p>
        <button
          @click="goHome"
    ...
    <!-- No Cards State -->
    <div
      v-else-if="!deck?.flashcards?.length"
      class="flex items-center justify-center min-h-96"
    >
      <div class="text-center max-w-md">
        <div
          class="w-20 h-20 bg-gradient-to-br from-green-100 to-green-200 rounded-full flex items-center justify-center mx-auto mb-6"
        >
          <svg
        ...
        <p class="text-gray-600 mb-6">
          This deck "{{ deck?.topic }}" doesn't have any flashcards to study.
          Flashcards can be generated from documents or created manually.
        </p>
        <div class="space-y-3">
          <button
            @click="goHome"
    ...
    <div v-else class="container mx-auto px-6 py-8">
      ...
      <div class="mb-8">
        ...
        >
          <span>Progress</span>
          <span
            >{{ currentCardIndex + 1 }} of {{ deck.flashcards.length }}</span
          >
        </div>
      ...
      <div class="max-w-2xl mx-auto">
        <div class="relative h-96 cursor-pointer" @click="flipCard">
          <!-- Card Container -->
          <div
          ...
          >
            ...
            <div class="absolute inset-0 w-full h-full backface-hidden">
              <div
                class="bg-white rounded-2xl shadow-lg p-8 h-full flex flex-col justify-center items-center text-center border-2 border-green-200"
              >
                <div class="mb-4">
                  <span
            ...
            >
              <div
                class="bg-green-50 rounded-2xl shadow-lg p-8 h-full flex flex-col justify-center items-center text-center border-2 border-green-300"
              >
                <div class="mb-4">
                  <span
        ...
        <!-- Completion Message -->
        <div
          v-if="currentCardIndex === deck.flashcards.length - 1 && isFlipped"
        ...
        >
          <div class="bg-green-100 border border-green-200 rounded-lg p-6">
            ...
            <p class="text-green-700 mb-4">
              You've reviewed all {{ deck.flashcards.length }} flashcards in
              this deck.
            </p>
            <button
              @click="goHome"
