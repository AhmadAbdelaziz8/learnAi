...
const isValidForm = computed(() => {
  return formData.value.topic.trim() && 
  ...
  <div class="max-w-2xl mx-auto p-6">
    <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-8">
      ...
      <div class="text-center mb-8">
        ...
        <p class="text-gray-600">Upload a PDF and let AI generate flashcards for you</p>
      </div>

      <!-- Error Message -->
      <div v-if="deckStore.createError" class="mb-6 p-4 bg-red-50 border border-red-200 rounded-lg">
      ...
      <form @submit.prevent="submitForm" class="space-y-6">
          ...
          <div v-else class="border border-gray-300 rounded-lg p-4">
            <div class="flex items-center justify-between">
              <div class="flex items-center">
                ...
                <div>
                  <p class="font-medium text-gray-900">{{ formData.pdfFile.name }}</p>
                  <p class="text-sm text-gray-500">{{ formatFileSize(formData.pdfFile.size) }}</p>
                </div>
              </div>
              <button
                type="button"
        ...
        <div class="flex gap-4">
          <button
            type="button"
            @click="router.go(-1)"
            class="flex-1 py-3 px-4 border border-gray-300 rounded-lg font-medium text-gray-700 hover:bg-gray-50 transition-colors focus:outline-none focus:ring-2 focus:ring-gray-500 focus:ring-offset-2"
            :disabled="deckStore.creating"
          >
            Cancel
          </button>
          ...
          >
            <div v-if="deckStore.creating" class="flex items-center justify-center">
